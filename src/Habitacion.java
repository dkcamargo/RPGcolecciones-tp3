...
/* Informatica Avanzada - 2021 */
    ...
    {
        this.salidas = new TreeMap<Salida, Habitacion>();
    ...
    {
        if (this.derramado != null) {
            return this.getDescripcionCorta() + ".\n" + getStringDeSalidas() + "\n" + getStringDeElementos();
            
        } else {
            try {
                return this.getDescripcionCorta() + ".\n" + "Se ha derramado " + this.getDerramado() + " en el piso.\n" + getStringDeSalidas() + "\n" + getStringDeElementos();
            } catch (Exception e) {
                return this.getDescripcionCorta() + ".\n" + getStringDeSalidas() + "\n" + getStringDeElementos();
            }
        }
    ...
    {
        Habitacion habitacionARetornar = salidas.get(direccion);
        if (habitacionARetornar != null) {
            return habitacionARetornar;
        } else {
 ...
 */ 
     ...
     */
     private class ConElementos extends EstadoContenedor {
        public String toString() {
            String stringARetornar = "Elementos: ";
            for (String nombreDelElemento: elementos.keySet()) {
                stringARetornar += nombreDelElemento + " ";
            }
        ...
        public Elemento getElemento(String nombre) throws AccionNoPermitidaException {
            Elemento elementoARetornar = elementos.remove(nombre);
            if(elementoARetornar != null) {
                if(elementos.size() == 0) {
                    estado = new Vacia();
                }
                return elementoARetornar;
            } else {
                throw new AccionNoPermitidaException("Ese elemento no existe");
            }
        }
...
*/
    ...
    public String getDerramado() throws AccionNoPermitidaException {
        if (this.derramado != null) {
            return this.derramado.getNombre();
        } else {
